export declare type IInnerEntitiesTypes = 'Alias' | 'Slot' | 'Text';
...
export declare type IChatitoCache = Map<string, IStatCache>;
export declare type IUtteranceWriter = (utterance: ISentenceTokens[], intentKey: string, isTrainingExample: boolean) => void;
